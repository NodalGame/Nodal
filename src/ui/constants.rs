...
pub(crate) const COLOR_CDTN_GREEN_UNSAT: Color = bevy::prelude::Color::Srgba(palettes::basic::GREEN);
pub(crate) const COLOR_RULE_YELLOW_SAT: Color = bevy::prelude::Color::Srgba(palettes::basic::YELLOW);
pub(crate) const COLOR_RULE_YELLOW_UNSAT: Color = bevy::prelude::Color::Srgba(palettes::basic::OLIVE);
