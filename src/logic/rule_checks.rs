pub mod rule_checks {
    ...
    use crate::structs::immutable::{game_set::game_set::GameSet, solution::solution::{solution_to_adjacency_matrix, Solution}};
...
#[cfg(test)]
mod tests {
    use crate::{logic::rule_checks::rule_checks::is_disconnected, structs::immutable::{game_line::game_line::GameLine, game_node::game_node::GameNode, game_set::game_set::GameSet, set_rule::set_rule::SetRule, solution::{self, solution::Solution}}};
    ...
    #[test]
    fn test_disconnected_no_connected_nodes_returns_true() {
